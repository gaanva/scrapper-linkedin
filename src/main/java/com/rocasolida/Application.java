...
public class Application {
	...
	public static void main(String[] args) {
		...
		/*
		 * DesiredCapabilities capabilities = DesiredCapabilities.phantomjs(); capabilities.setCapability("phantomjs.binary.path", "C:\\Users\\gvaldez\\drivers\\phantomjs.exe"); capabilities.setCapability( "phantomjs.page.settings.userAgent","Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2062.120 Safari/537.36" ); //Creo el webdriver WebDriver driver = new PhantomJSDriver(capabilities); //Accedo a la página que quiero scrapear
		 */
