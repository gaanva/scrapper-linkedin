...
public class Scrap {
  ...
  private void setupRemoteDriver(Driver driverResource) throws MalformedURLException {
    ...
    this.driver = new RemoteWebDriver(
        new URL("http://" + driverResource.getSeleniumHost() + ":" + driverResource.getSeleniumPort() + "/wd/hub"),
        capabilities);
  ...
  public void initLocalDriver(Driver driver) {
    if (driver != null
        && (driver.getType().equals(DriverType.FIREFOX_HEADLESS) || driver.getType().equals(DriverType.FIREFOX))) {
      ...
      this.configureDriver();
        ...
        && (driver.getType().equals(DriverType.CHROME_HEADLESS) || driver.getType().equals(DriverType.CHROME))) {
